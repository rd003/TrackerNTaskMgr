...
public class TaskCreateValidator : AbstractValidator<TaskCreateDTO>
{
    ...
    {
        RuleFor(t => t.TaskHeaderId).NotEmpty().WithMessage("TaskHeader can not be null");
        ...
        RuleFor(t => t.TaskUri).MaximumLength(300).WithMessage("TaskUri can not exceed 300 characters");
